                                ...
                                {(provided) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-auto pr-2 flex items-center gap-x-2">
                                            ...
                                            <Badge variant={"default"} className="font-regular text-xs px-2 hidden md:block lg:hidden xl:block cursor-default noselect bg-primary/50 text-primary-foreground">
                                                {chapter.isPublished ? "Publicado" : "Rascunho"}
                                            </Badge>
                                            <FaPencil
                                                onClick={() => onEdit(chapter.id)}
                                                className="w-4 h-4 cursor-pointer hover:opacity-80 mr-1 py-[0.5px] text-SoulBlue"
                                            />
                                        </div>
                                    </div>
                                )}
